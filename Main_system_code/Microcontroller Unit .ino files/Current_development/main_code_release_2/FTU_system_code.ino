...
void loop() {
 ...
 analogReadResolution(10);
 measured_magnetic_field = ((analogRead(A1) * 3340 * 0.1 ) / 1024.00) - 273;
// Serial.println(measured_magnetic_field, 3);
...
/* thermocouple code                                                    */
/************************************************************************/
// https://www.electronicwings.com/arduino/thermocouple-interfacing-with-arduino-uno

float thermocouple_temperature(int thermocouple_pin){
	  int adc_val = analogRead(thermocouple_pin);
